...
export const projects: Project[] = [
  ...
  },
  {
    ...
    summary: "Built the founding prototype and pitched it to Adobe leadership, leading to the launch of a generative-AI platform for creating on-brand marketing content at scale.",
