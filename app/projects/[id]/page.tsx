        ...
        <article className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="mb-8">
            <div className="flex flex-wrap gap-2 mb-4">
                  {project.tags.map((tag) => (
                    <span
                      key={tag}
                      className="px-3 py-1 bg-[var(--accent-bg)] text-[var(--accent)] text-sm font-medium rounded-full border border-[var(--accent-border)]"
                    >
                      {tag}
                    </span>
                  ))}
            ...
            {project.github && (
              <a
                ...
                className="inline-flex items-center px-4 py-2 bg-[var(--text)] text-white rounded-lg hover:opacity-90 transition-colors"
              >
          ...
          <div className="prose prose-lg max-w-none">
            <div className="bg-[var(--accent-bg)] p-6 rounded-lg mb-8 border border-[var(--accent-border)]">
              <p className="text-lg text-[var(--text-secondary)] font-medium">{project.summary}</p>
            </div>
