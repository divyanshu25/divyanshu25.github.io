...
```
teacher sees the full image:  [p1] [p2] [p3] [p4] ... [p256]  -> a distribution per patch
student sees it masked:       [p1] [##] [p3] [##] ... [p256]
loss: at every ## the student must predict the teacher's distribution for that patch
```
