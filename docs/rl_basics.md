...
3. **Token-Level Policy Gradient Loss**: normalize the loss over *total tokens* rather than per-sequence-then-averaged, so long responses aren't under-weighted.
