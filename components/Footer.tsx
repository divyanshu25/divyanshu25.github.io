      ...
      <div className="relative max-w-7xl mx-auto px-6 sm:px-8 lg:px-16">
        <div className="flex flex-col items-center space-y-6">
          ...
          <div className="text-center">
            <h3 className="text-xl font-bold text-white mb-1.5">Divyanshu Goyal</h3>
          ...
          <div className="flex space-x-4">
            <a
              ...
              className="p-2.5 bg-white/5 hover:bg-white/10 rounded-xl text-gray-400 hover:text-white transition-all duration-300 hover:scale-110 border border-white/10"
              aria-label="GitHub"
            >
