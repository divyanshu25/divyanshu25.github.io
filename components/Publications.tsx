      ...
      <div className="relative max-w-7xl mx-auto px-6 sm:px-8 lg:px-16">
        ...
        <div className="space-y-8">
          {profile.publications.map((pub, index) => (
            <div
              key={index}
              className="group relative bg-white p-8 sm:p-10 rounded-3xl hover-lift shadow-xl hover:shadow-2xl border border-gray-200 hover:border-blue-300 transition-all overflow-hidden"
            >
              ...
              <div className="relative">
                ...
                <div className="flex flex-wrap items-center gap-4">
                  <a
                    ...
                    className="inline-flex items-center gap-2 px-6 py-3 bg-gradient-to-r from-blue-600 to-indigo-600 text-white rounded-xl font-semibold hover-lift button-press shadow-lg hover:shadow-xl transition-all group/btn"
                  >
